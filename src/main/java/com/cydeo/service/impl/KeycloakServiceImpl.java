...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    public Response userCreate(UserDTO userDTO) {
        ...
        CredentialRepresentation credential = new CredentialRepresentation();// Setting password
        credential.setType(CredentialRepresentation.PASSWORD);
        credential.setTemporary(false);
        credential.setValue(userDTO.getPassWord());

        UserRepresentation keycloakUser = new UserRepresentation(); // Setting user information
        ...
        Keycloak keycloak = getKeycloakInstance(); // creating an instance of keycloak, like opening a transaction
