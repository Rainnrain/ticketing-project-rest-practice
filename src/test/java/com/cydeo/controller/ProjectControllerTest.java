...
//UNIT testing for the controller
    ...
    private static String getToken() {
        ...
        RestTemplate restTemplate = new RestTemplate();// sends api requests for real
        ...
        map.add("client_secret", "Cc2XlaPtNACZH0ZeEobtlpyFYmv9ZXmR");
